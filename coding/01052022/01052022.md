## Haizz chết tiệt ! Cái CSS chết tiệt này, z-index nó đang làm cái quái gì vậy hả ?

Để hiểu hơn về `z-index` nó làm cái gì thì hãy đọc bài post này.

Trước tiên, có 1 vài thuật ngữ được sử dụng trong bài này:

- Element: là 1 tag trong `html`: `div p img, etc...`
- Children: các element con trong element
...
- `z-index` có thể nhận vào giá trị âm.
...
- `Stacking context` có thể gắn với element bằng 1 trong các cách dưới đây:
...
**Stacking order trong stacking context:** Dưới đây là các rule để xác định stacking order trong stacking context ( Theo thứ tự từ thấp đến cao)
